...
export default defineConfig({
  plugins: [
    reactNativeWeb(),
    crossedStyled.default({ configPath: './src/style.config.ts' }),
  ]
});
`;
  ...
  <BuilderTab defaultValue="webpack" variant="underline">
    ...
    <PlatformTab.Panel value="web">
      <BuilderTab.List>
        ...
        <BuilderTab.Tab value="vite">
          <BuilderTab.Tab.Text>vite</BuilderTab.Tab.Text>
        </BuilderTab.Tab>
        ...
        <BuilderTab.Panel value="vite">
          <Source language='bash' code={"pnpm i @crossed/styled vite-plugin-crossed-styled vite-plugin-react-native-web"} />
        </BuilderTab.Panel>
    </PlatformTab.Panel>
