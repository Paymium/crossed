...
export const form = createStyles(
  ({ space, font, colors, components: { Input } }) => {
    const inputFocus = { base: { borderColor: Input.primary.focus.border } };
    const inputHover = { base: { borderColor: Input.primary.hover.border } };
    const inputActive = { base: { borderColor: Input.primary.focus.border } };
    return {
      inputError: {
        base: {
      ...
      input: {
        ...
        ':hover': inputHover.base,
        ':focus': inputFocus.base,
        ':active': inputActive.base,
        ':disabled': {
