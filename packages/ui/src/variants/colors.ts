// import { singleton } from '@crossed/twrnc';
import type { BaseWithState, CustomColor, TwColors } from '@crossed/core';
import colors from '@colorVariant';

console.log('config', colors as CustomColor);

export const colorVariants = Object.entries(colors as CustomColor).reduce(
  (acc, [color, tColor]) => {
