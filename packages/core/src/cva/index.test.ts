...
describe('cva', () => {
  test('empy', () => {
    ...
    expect(toto({ size: 'md', color: 'black' })).toEqual({
      className: ['titi'],
    });
  });
  // describe('without base', () => {
  describe.skip('without anything', () => {
    test('empty', () => {
  ...
  //             ],
  //           },
  //           danger: { className: ['button--danger', 'hover:bg-red-600'] },
  //         },
  //         disabled: {
  //           true: {
  //             className: ['button--disabled opacity-050 cursor-not-allowed'],
  //           },
  //           false: { className: ['button--enabled cursor-pointer'] },
  //         },
  //         size: {
  //           small: { className: ['button--small text-sm py-1 px-2'] },
  //           medium: { className: ['button--medium text-base py-2 px-4'] },
  //           large: { className: ['button--large text-lg py-2.5 px-4'] },
  //         },
  //         m: {
  //           0: { className: ['m-0'] },
  //           1: { className: ['m-1'] },
  ...
  //           small: { className: ['button--small', 'text-sm', 'py-1', 'px-2'] },
  //           medium: {
  //             className: ['button--medium', 'text-base', 'py-2', 'px-4'],
  //           },
  //           large: {
  //             className: ['button--large', 'text-lg', 'py-2.5', 'px-4'],
  //           },
  //         },
  //         m: {
  //           0: { className: ['m-0'] },
  ...
  //           },
  //           danger: {
  //             className: ['button--danger', 'hover:bg-red-600'],
  //           },
  //         },
  //         disabled: {
  //           true: {
  ...
  //           size: {
  //             small: {
  //               className: ['button--small', 'text-sm', 'py-1', 'px-2'],
  //             },
  //             medium: {
  //               className: ['button--medium', 'text-base', 'py-2', 'px-4'],
  //             },
